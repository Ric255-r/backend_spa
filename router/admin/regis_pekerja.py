    ...
    async with pool.acquire() as conn:
      async with conn.cursor() as cursor:
        try:
          ...
          q1 = """
            INSERT INTO karyawan (id_karyawan, nik, nama_karyawan, alamat, jk, no_hp, umur, jabatan, kontrak_img) 
            VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s)
          """
          await cursor.execute(q1, (data['id_karyawan'], data['nik'], data['nama_karyawan'], data['alamat'], data['jk'], data['no_hp'], data['umur'], data['jabatan'],  data['kontrak_img'])) 
